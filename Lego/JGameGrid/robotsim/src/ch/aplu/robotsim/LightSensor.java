...
public class LightSensor extends Part
{
  ...
  {
    {
      new Location(8, 7), new Location(8, -7), new Location(8, 0), new Location(-35, 0)
    },
    {
      new Location(8, 7), new Location(8, -7), new Location(-35, 7), new Location(-35, -7)
    }
  };
  ...
  public LightSensor(SensorPort port, boolean upwards)
  {
    super("sprites/lightsensor"
      ...
      : (port == SensorPort.S3 ? (upwards ? "_rear.gif" : ".gif") : "_rear.gif"))),
      port == SensorPort.S1 ? locs[upwards ? 1 : 0][0]
      : (port == SensorPort.S2 ? locs[upwards ? 1 : 0][1]
      : (port == SensorPort.S3 ? locs[upwards ? 1 : 0][2] : locs[upwards ? 1 : 0][3])));
    this.port = port;
